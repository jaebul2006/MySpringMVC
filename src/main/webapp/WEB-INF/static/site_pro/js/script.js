...
$.include('./static/site_pro/js/superfish.js')
$.include('./static/site_pro/js/FF-cash.js')
$.include('./static/site_pro/js/tms-0.4.x.js')
$.include('./static/site_pro/js/uCarausel.js')
$.include('./static/site_pro/js/jquery.easing.1.3.js')
$.include('./static/site_pro/js/jquery.tools.min.js')
$.include('./static/site_pro/js/jquery.jqtransform.js')
$.include('./static/site_pro/js/jquery.quicksand.js')
$.include('./static/site_pro/js/jquery.snippet.min.js')
$.include('./static/site_pro/js/jquery-ui-1.8.17.custom.min.js')
$.include('./static/site_pro/js/jquery.cycle.all.min.js')
$.include('./static/site_pro/js/jquery.cookie.js')
$(function(){
